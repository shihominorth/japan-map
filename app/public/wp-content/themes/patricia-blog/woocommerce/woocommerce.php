...
# WooCommerce Support.
-------------------------------------------------------------------------*/  
function patricia_blog_woocommerce_setup() {
...
add_action( 'after_setup_theme', 'patricia_blog_woocommerce_setup' );
...
-------------------------------------------------------------------------*/  
function patricia_blog_woocommerce_scripts() {

	wp_enqueue_style( 'patricia-blog-woocommerce-style', get_template_directory_uri() . '/woocommerce/css/woocommerce.css' );

}
add_action( 'wp_enqueue_scripts', 'patricia_blog_woocommerce_scripts' );
...
# Get WC Header cart
-------------------------------------------------------------------------*/
if ( ! function_exists( 'patricia_blog_header_cart' ) ) {
    function patricia_blog_header_cart() {

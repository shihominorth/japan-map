...
if (!class_exists('patricia_about_widget')) :
    ...
    class patricia_about_widget extends WP_Widget
    {
         ...
         * Constructor.
         *
         * @since Patricia Blog 1.0.8
         */
        function __construct()
        {
            $opts = array(
                'classname' => 'patricia_blog_about_widget',
                'description' => esc_html__('Display Author Profile.', 'patricia-blog'),
                'customize_selective_refresh' => true,
            );
            parent::__construct('patricia-blog-author', esc_html__('[VT] About Widget', 'patricia-blog'), $opts);
        }
					...
					<?php if ($author_facebook) { ?>
						<li>
							<a class="fab fa-facebook-f" href="<?php echo esc_url($author_facebook); ?>" target="_blank">
								<span class="screen-reader-text"><?php esc_html_e('facebook', 'patricia-blog'); ?></span>
							</a>
						</li>
					<?php } ?>
					...
					<?php if ($author_twitter) { ?>
						<li>
							<a class="fab fa-twitter" href="<?php echo esc_url($author_twitter); ?>" target="_blank">
								<span class="screen-reader-text"><?php esc_html_e('twitter', 'patricia-blog'); ?></span>
							</a>
						</li>
					<?php } ?>
					...
					<?php if ($author_linkedin) { ?>
						<li>
							<a class="fab fa-linkedin" href="<?php echo esc_url($author_linkedin); ?>" target="_blank">
								<span class="screen-reader-text"><?php esc_html_e('linkedin', 'patricia-blog'); ?></span>
							</a>
						</li>
					<?php } ?>
					...
					<?php if ($author_pinterest) { ?>
						<li>
							<a class="fab fa-pinterest" href="<?php echo esc_url($author_pinterest); ?>" target="_blank">
								<span class="screen-reader-text"><?php esc_html_e('pinterest', 'patricia-blog'); ?></span>
							</a>
						</li>
					<?php } ?>
					...
					<?php if ($author_instagram) { ?>
						<li>
							<a class="fab fa-instagram" href="<?php echo esc_url($author_instagram); ?>" target="_blank">
								<span class="screen-reader-text"><?php esc_html_e('instagram', 'patricia-blog'); ?></span>
							</a>
						</li>
					<?php } ?>
					...
					<?php if ($author_youtube) { ?>
						<li>
							<a class="fab fa-youtube" href="<?php echo esc_url($author_youtube); ?>" target="_blank">
								<span class="screen-reader-text"><?php esc_html_e('youtube', 'patricia-blog'); ?></span>
							</a>
						</li>
					<?php } ?>
        ...
        function form($instance)
        {
            ...
            // Defaults.
            $defaults = array(
                'title' => esc_html__('About Me', 'patricia-blog' ),
                'author_description' => '',
                'author_facebook' => '',
                'author_twitter' => '',
                'author_linkedin' => '',
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'patricia-blog'); ?></strong></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('author_description')); ?>"><strong><?php esc_html_e('Description:', 'patricia-blog'); ?></strong></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_image'); ?>">
                    <?php esc_html_e('Select Image', 'patricia-blog'); ?>
                </label>
                <br/>
                <?php
                ...
                <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                       name="<?php echo $this->get_field_name('author_image'); ?>"
                       value="<?php esc_attr_e('Upload Image', 'patricia-blog') ?>"/>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_facebook')); ?>">
                    <?php esc_html_e('Facebook:', 'patricia-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_twitter')); ?>">
                    <?php esc_html_e('Twitter:', 'patricia-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_linkedin')); ?>">
                    <?php esc_html_e('LinkedIn:', 'patricia-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_pinterest')); ?>">
                    <?php esc_html_e('Pinterest:', 'patricia-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_instagram')); ?>">
                    <?php esc_html_e('Instagram:', 'patricia-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_youtube')); ?>">
                    <?php esc_html_e('Youtube:', 'patricia-blog'); ?>
                </label>
...
add_action('admin_enqueue_scripts', 'patricia_blog_widgets_backend_enqueue');
function patricia_blog_widgets_backend_enqueue()
{
    wp_register_script('patricia-blog-custom-widgets', get_template_directory_uri() . '/assets/js/widget.js', array('jquery'), true);
    wp_enqueue_media();
    wp_enqueue_script('patricia-blog-custom-widgets');
}
...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'patricia-blog' ), // Required
...
$panels[] = array(
	'id' => $panel,
	'title' => __( 'Panel Examples', 'patricia-blog' ),
	'priority' => '100'
);
...
$sections[] = array(
	'id' => $section,
	'title' => __( 'Panel Section', 'patricia-blog' ),
	'priority' => '10',
	'panel' => $panel
);
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-radio'] = array(
	'id' => 'example-radio',
	'label'   => __( 'Example Radio', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'radio',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-upload'] = array(
	'id' => 'example-upload',
	'label'   => __( 'Example Upload', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'upload',
	'default' => '',
);
...
$options['example-color'] = array(
	'id' => 'example-color',
	'label'   => __( 'Example Color', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'color',
	'default' => $color // hex
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'patricia-blog'),
);
~~~
...
$options['example-font'] = array(
	'id' => 'example-font',
	'label'   => __( 'Example Font', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'select',
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'patricia-blog' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
...
function patricia_blog_fonts() {
	...
	// Load Google Fonts
	wp_enqueue_style( 'patricia_blog_fonts', $font_uri, array(), null, 'screen' );

}
add_action( 'wp_enqueue_scripts', 'patricia_blog_fonts' );
~~~

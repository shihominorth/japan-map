				...
				<div class="entry-content">
					...
					<?php if ( has_post_thumbnail() ) : ?>
						<div class="patricia-thumbnail">
							<?php the_post_thumbnail('patricia_blog_blog_post'); ?>
						</div>
					<?php endif; ?>

					<div class="entry-summary">
						<?php the_content(); ?>
						<?php edit_post_link( __( 'Edit', 'patricia-blog' ), '<span class="edit-link">', '</span>' ); ?>
					</div>
					...
					<?php
						...
						if ( get_the_tags() ) : ?>
							...
							<div class="vt-post-tags">
								<h6><?php esc_html_e( 'Related Topics', 'patricia-blog' ); ?></h6>
								<?php the_tags('',' '); ?>
							</div>
					  <?php
						endif;
